...
| `internal/polish` | Shared copy-edit engine: the LLM-judge-selected system prompt, grounded link-candidate gathering, invented-link stripper, and snapshot/undo primitives (imported by both `cli` and `mcp`) |
