...
### Changed
- `2nb graph` takes a document path and always has. The command table in the README, in the agent skill, and in the CLI reference described it as the whole vault's link graph
